...
jint Java_com_github_xueqingxiao_shadowvpn_ShadowVPN_nativeInitVPN(JNIEnv *env, jobject thiz,
...
jint Java_com_github_xueqingxiao_shadowvpn_ShadowVPN_nativeStopVPN(JNIEnv *env, jobject thiz) {
    return vpn_stop(&vpn_ctx);
}

jint Java_com_github_xueqingxiao_shadowvpn_ShadowVPN_nativeGetSockFd(JNIEnv *env, jobject thiz) {
    return sock;
}
